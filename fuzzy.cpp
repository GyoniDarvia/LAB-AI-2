...
// TAHAP INFERENCE
float inference() {
  cout << "   [R1] IF Permintaan TURUN And Persediaan BANYAK THEN Produksi "
          "Barang BERKURANG"
       << endl;
  ...
  cout << "   [R2] IF Permintaan TURUN And Persediaan SEDIKIT THEN Produksi "
          "Barang BERKURANG"
       << endl;
  ...
  cout << "   [R3] IF Permintaan NAIK And Persediaan BANYAK THEN Produksi "
          "Barang BERTAMBAH"
       << endl;
  ...
  cout << "   [R4] IF Permintaan NAIK And Persediaan SEDIKIT THEN Produksi "
          "Barang BERTAMBAH"
       << endl;
...
int main() {
  ...
  z = ((a_pre1 * z1) + (a_pre2 * z2) + (a_pre3 * z3) + (a_pre4 * z4)) /
      (a_pre1 + a_pre2 + a_pre3 + a_pre4);
  cout << "   z* = " << z << endl << endl;
  def_z = round(z);
  cout << "   Jadi jumlah kemasan makanan jenis ABC yang harus diproduksi "
          "sebanyak "
       << def_z << endl;
